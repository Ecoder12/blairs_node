...
expenses.
      ...
      I understand that Tommy Blair’s is not responsible for any damage to the vehicle resulting 
from any act of nature including, without limitation, damage caused by hail, wind, fire, or flood.

      I understand and agree that Tommy Blair’s may provide my contact information to a third-party
organization that may contact me for the sole purpose of conducting a customer satisfaction survey.

      LIMITED WARRANTY. Subject to the specified exclusions and exceptions, Tommy Blair’s provides a 
...
as I own the vehicle. During the limited warranty period, Tommy Blair’s will repair or replace any defects 
caused by Tommy Blair’s or its agents. All warranty repairs must be performed at one of Tommy Blair’s 
facilities; any repairs or alterations to the vehicle performed non-Tommy Blair’s facility in any manner 
whatsoever shall automatically void this limited warranty. This limited warranty shall not apply to 
repairs necessitated by any cause beyond the reasonable control of Tommy Blair’s, including any defects, 
...
party other than Tommy Blair’s, abuse, misuse, neglect, acts of God, or environmental damage. 
...
PARTICULAR PURPOSE.
      ...
      LIMITATION OF LIABILITY. In no event shall Tommy Blair’s be liable for consequential, special, or 
indirect damages of any nature, and Tommy Blair’s maximum liability shall be no greater than the amount 
actually paid to, and received by, Tommy Blair’s for the services performed on the vehicle.
...
Tommy Blair’s. This Repair Authorization shall supersede all prior oral and written discussions, agreements, and 
...
doc.moveDown();
  ...
  doc.text(`I authorize any and all supplements payable direct to Tommy Blair’s Inc dba Quality Collision Repair.  I authorize Tommy Blair’s Inc dba Quality Collision Repair POWER OF ATTORNEY TO SIGN supplement payments.`);
  doc.moveDown();
