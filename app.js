...
function generateFile(content) {
  ...
  const fileName = `TB${formattedDate}${formattedTime}.txt`;
...
expenses.
      ...
      I understand that Tommy Blair’s Inc dba Quality Collision Repair  is not responsible for any damage to the vehicle resulting 
from any act of nature including, without limitation, damage caused by hail, wind, fire, or flood.

      I understand and agree that Tommy Blair’s Inc dba Quality Collision Repair  may provide my contact information to a third-party
organization that may contact me for the sole purpose of conducting a customer satisfaction survey.

      LIMITED WARRANTY. Subject to the specified exclusions and exceptions, Tommy Blair’s Inc dba Quality Collision Repair  provides a 
...
as I own the vehicle. During the limited warranty period, Tommy Blair’s Inc dba Quality Collision Repair  will repair or replace any defects 
caused by Tommy Blair’s Inc dba Quality Collision Repair  or its agents. All warranty repairs must be performed at one of Tommy Blair’s Inc dba Quality Collision Repair  
facilities; any repairs or alterations to the vehicle performed non-Tommy Blair’s Inc dba Quality Collision Repair  facility in any manner 
whatsoever shall automatically void this limited warranty. This limited warranty shall not apply to 
repairs necessitated by any cause beyond the reasonable control of Tommy Blair’s Inc dba Quality Collision Repair , including any defects, 
...
party other than Tommy Blair’s Inc dba Quality Collision Repair , abuse, misuse, neglect, acts of God, or environmental damage. 
...
PARTICULAR PURPOSE.
      ...
      LIMITATION OF LIABILITY. In no event shall Tommy Blair’s Inc dba Quality Collision Repair  be liable for consequential, special, or 
indirect damages of any nature, and Tommy Blair’s Inc dba Quality Collision Repair  maximum liability shall be no greater than the amount 
actually paid to, and received by, Tommy Blair’s Inc dba Quality Collision Repair  for the services performed on the vehicle.
...
Tommy Blair’s Inc dba Quality Collision Repair . This Repair Authorization shall supersede all prior oral and written discussions, agreements, and 
...
writing and signed by both you and an authorized manager of Tommy Blair’s Inc dba Quality Collision Repair .

      I authorize any and all supplements payable direct to Tommy Blair’s Inc dba Quality Collision Repair  Inc dba Quality Collision Repair.  I authorize Tommy Blair’s Inc dba Quality Collision Repair 
...
doc.moveDown();
  ...
  doc.text(`I understand that Tommy Blair’s Inc dba Quality Collision Repair  is not responsible for any damage to the vehicle resulting from any act of nature including, without limitation, damage caused by hail, wind, fire, or flood.`);
  doc.moveDown();

  doc.text(`I understand and agree that Tommy Blair’s Inc dba Quality Collision Repair  may provide my contact information to a third-party organisation that may contact me for the sole purpose of conducting a customer satisfaction survey.`);
  doc.moveDown();

  doc.text(`LIMITED WARRANTY. Subject to the specified exclusions and exceptions, Tommy Blair’s Inc dba Quality Collision Repair  provides a limited warranty for the work performed under this Repair Authorization. This limited warranty includes all repairs, paint and workmanship on sheet metal, frame, unitized chassis components, and mechanical items, but specifically excludes electric systems. This limited warranty is subject to any manufacturer’s warranty covering parts and materials. This limited warranty is non-transferable and valid for as long as I own the vehicle. During the limited warranty period, Tommy Blair’s Inc dba Quality Collision Repair  will repair or replace any defects caused by Tommy Blair’s Inc dba Quality Collision Repair  or its agents. All warranty repairs must be performed at one of Tommy Blair’s Inc dba Quality Collision Repair  facilities; any repairs or alterations to the vehicle performed Non-Tommy Blair’s Inc dba Quality Collision Repair  facility in any manner whatsoever shall automatically void this limited warranty. This limited warranty shall not apply to repairs necessitated by any cause beyond the reasonable control of Tommy Blair’s Inc dba Quality Collision Repair  Inc dba Quality Collision Repair, including any defects, damage, or malfunctions caused by or resulting from unauthorized service or parts, improper or inadequate vehicle maintenance, alterations, accidents, modification or repairs, subsequent repairs performed by a party other than Tommy Blair’s Inc dba Quality Collision Repair  Inc dba Quality Collision Repair, abuse, misuse, neglect, acts of God, or environmental damage. THE WARRANTIES AS SET FORTH IN THIS SERVICE CONTRACT ARE IN LIEU OF ALL OTHER WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, ANY IMPLIED WARRANTY OF MERCHANTABILITY OR FITNESS FOR A PARTICULAR PURPOSE.`);
  doc.moveDown();

  doc.text(`LIMITATION OF LIABILITY. In no event shall Tommy Blair’s Inc dba Quality Collision Repair  be liable for consequential, special, or indirect damages of any nature, and Tommy Blair’s Inc dba Quality Collision Repair  maximum liability shall be no greater than the amount actually paid to, and received by, Tommy Blair’s Inc dba Quality Collision Repair  for the services performed on the vehicle.`);
  doc.moveDown();
  ...
  doc.text(`ENTIRE AGREEMENT. The terms contained in this Repair Authorization constitute the entire agreement between you and Tommy Blair’s Inc dba Quality Collision Repair  Inc dba Quality Collision Repair. This Repair Authorization shall supersede all prior oral and written discussions, agreements, and understandings of the parties regarding the subject matter of this Authorization. No modification, amendment, supplement to or waiver of this Repair Authorization or its terms and conditions shall be binding upon either party unless made in writing and signed by both you and an authorized manager of Tommy Blair’s Inc dba Quality Collision Repair  Inc dba Quality Collision Repair.`);
  doc.moveDown();

  doc.text(`I authorize any and all supplements payable direct to Tommy Blair’s Inc dba Quality Collision Repair  Inc dba Quality Collision Repair.  I authorize Tommy Blair’s Inc dba Quality Collision Repair  POWER OF ATTORNEY TO SIGN supplement payments.`);
  doc.moveDown();
  ...
  const fileName = `TB${formattedDate}${formattedTime}.pdf`;
  const filePath = `./${fileName}`;
